...
function spawnEnemy(){
  ...
  enemies.push({type,x:30+Math.random()*(W-60),y:-35,r:type==='cruiser'?26:15,hp:(type==='cruiser'?6:2)+state.level,
...
function draw(){
  ...
  enemies.forEach(enemy=>ship(enemy.x,enemy.y,enemy.r,enemy.color,true));if(boss)drawBoss();
